class Constants {
  ...
  static final String base_url = "https://www.sigma.star-x.co.za/";
  ...
  static final String getUnfollowedBrandsUrl =
      base_url + "getunfollowedbrands.php";
  ...
  static final String getChatConversationsUrl =
      base_url + "getchatsconversations.php";
  ...
  static final String getTwitsUrl = base_url + "gettwitterfeeds.php";
}
